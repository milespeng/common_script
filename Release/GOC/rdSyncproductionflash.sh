...
##
git_dir=/home/qa/Git/goc_flash/webapp/lobby
...
testing=$s3url/test_goc
production=$s3url/prod_goc
backup=$s3url/test_goc_compatibility
...
prod_config() {
    ...
    do
        ...
        sed -i "s/test_goc/prod_goc\/$version/g" $storage_file/$file/xml/$config 
...
#backup test_goc in order for compatibility testing.
backup(){
